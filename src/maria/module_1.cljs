...
;; our smallest unit: a single square. We'll build our checkerboard
;; code step by step, so that it gradually grows into the final shape
;; we want.
...
(colorize "red" (rectangle 25 25))

(colorize "black" (rectangle 25 25))
...
(let [r (colorize "red" (rectangle 25 25)) ;; same as above
      b (colorize "black" (rectangle 25 25)) ;; same as above
