 ...
 * Modified by Matthew Huebert (for bracket differentiation)
 */
...
(function(mod) {
    ...
    CodeMirror.defineMode("clojure", function (options) {
        ...
        function bracketType(ch) {
            ...
            switch (ch) {
                case "(":
                    out = "bracket bracket-round bracket-open ";
                    break;
                case ")":
                    out = "bracket bracket-round bracket-close ";
                    break;
                case "[":
                    out = "bracket bracket-square bracket-open ";
                    break;
                case "]":
                    out = "bracket bracket-square bracket-close ";
                    break;
                case "{":
                    out = "bracket bracket-curly bracket-open ";
                    break;
                case "}":
                    out = "bracket bracket-curly bracket-close ";
                    break;
            }
            return out
        }
